...
<head>
    <meta charset="utf-8"/>
    <title>Admin | Outfitrr v1.0</title>
...
<section class="hbox stretch">
    <?php  if (!empty($this->session->userdata['admin_user_id'])): ?>
        ...
        <section class="vbox">
            ...
            <section>
                <nav class="nav-primary hidden-xs">
                    <ul class="nav">
                        <li class="<?php echo in_array('dashboard', $this->uri->segment_array()) ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/dashboard'); ?>"><span>Dashboard</span></a></li>
                        ...
                        <li class="<?php echo in_array('products', $this->uri->segment_array()) ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/products'); ?>"><span>Products</span></a></li>
                        <li class="<?php echo in_array('orders', $this->uri->segment_array()) ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/orders'); ?>"><span>Orders</span></a></li>
                        ...
                        <li class="<?php echo in_array('pages', $this->uri->segment_array()) ? 'active' : ''; ?>"><a href="<?php echo site_url('admin/comments'); ?>"><span>Comments</span></a></li>
